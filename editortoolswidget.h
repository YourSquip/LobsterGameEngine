...
class EditorToolsWidget : public QWidget
{
    Q_OBJECT
public:
    EditorToolsWidget(Viewport* level_view,QWidget *parent = nullptr)
    {
        ...
        QPixmap pixmap("D:/QtProjects/LobsterGameEngine2.0/LobsterGameEngine/sprites/paint_brush.png");
        ...
        m_eraser_tool_bttn->setIcon(QIcon("D:/QtProjects/LobsterGameEngine2.0/LobsterGameEngine/sprites/eraser.png"));
        m_eraser_tool_bttn->setIconSize(QSize(32,32));

        m_coursor_tool_bttn = new QPushButton(this);
        m_coursor_tool_bttn->resize(32,32);
        m_coursor_tool_bttn->setIcon(QIcon("D:/QtProjects/LobsterGameEngine2.0/LobsterGameEngine/sprites/coursor.png"));
        m_coursor_tool_bttn->setIconSize(QSize(32,32));

        m_move_tool_bttn = new QPushButton(this);
        m_move_tool_bttn->resize(32,32);
        m_move_tool_bttn->setIcon(QIcon("D:/QtProjects/LobsterGameEngine2.0/LobsterGameEngine/sprites/transform.png"));
